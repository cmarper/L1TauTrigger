{
  ...
  TFile f_mean("/home/llr/cms/mperez/TauTrigger/CMSSW_9_2_10/src/TauTagAndProbe/TauTagAndProbe/test/Trees_meanparam/histos_rate_Run306091_306092_92X_mean.root","READ");
  TFile f_mean_newnTT("/home/llr/cms/mperez/TauTrigger/CMSSW_9_2_10/src/TauTagAndProbe/TauTagAndProbe/test/Trees_meanparam/histos_rate_Run306091_306092_92X_mean_newnTT.root","READ");
  ...
  TString CanvasName = "./PlotIsolation/PlotRate/Comparison_Rate_Run306091_306092_92X_mean_oldnewnTT";
...
*/
  ...
  texl->AddText("CMS Internal, #sqrt{s}=13 TeV, Run #306091/2 (PU ~ 57)");
 ...
 */
 ...
 // ratioPlot22_unpacked->Draw("same");
  ...
  Double_t Threshold_NewLayer1_Option22_newnTT = 0.;
...
*/
  ...
  for(UInt_t i = 1 ; i <= rate_NewLayer1_Option22_mean_newnTT->GetNbinsX() ; ++i)
    {
      if(rate_NewLayer1_Option22_mean_newnTT->GetBinContent(i)<=Target)
        {
          Threshold_NewLayer1_Option22_newnTT = rate_NewLayer1_Option22_mean_newnTT->GetBinLowEdge(i);
          break;
        }
    }
  ...
  */
  ...
  cout<<"Double_t Threshold_NewLayer1_Option22_newnTT = "<<Threshold_NewLayer1_Option22_newnTT-0.49<<";"<<endl;
 ...
 */
   ...
   cout<<"TString Threshold_NewLayer1_Option22_newnTT = \""<<Threshold_NewLayer1_Option22_newnTT<<"\";"<<endl;
