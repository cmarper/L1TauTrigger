...
//  FileNameOut_emulated_mode += ".root";
  TString FileNameOut_emulated_mean = "./Trees_meanparam/turnOns_Option22_differentthresholds_mean";
...
//  FileNameOut_unpacked += ".root";
  ...
  */
  TString Threshold_NewLayer1_Option22_mean_thr21 = "21"; 
  TString Threshold_NewLayer1_Option22_mean_thr23 = "23";
  TString Threshold_NewLayer1_Option22_mean_thr25 = "25";
...
//  TString Threshold_NewLayer1_noIso_mode = "41"
  ...
  */
  ...
  TGraphAsymmErrors* eff_Stage2_iso_Option22_mean_thr21 = (TGraphAsymmErrors*)f_Stage2_emulated_mean.Get("divide_pt_pass_Option22_thr21_by_pt");
  TGraphAsymmErrors* eff_Stage2_iso_Option22_mean_thr23 = (TGraphAsymmErrors*)f_Stage2_emulated_mean.Get("divide_pt_pass_Option22_thr23_by_pt");
  TGraphAsymmErrors* eff_Stage2_iso_Option22_mean_thr25 = (TGraphAsymmErrors*)f_Stage2_emulated_mean.Get("divide_pt_pass_Option22_thr25_by_pt");
  /*
  ...
  */
  ...
  eff_Stage2_iso_Option22_mean_thr21->SetLineWidth(2);
  eff_Stage2_iso_Option22_mean_thr23->SetLineWidth(2);
  eff_Stage2_iso_Option22_mean_thr25->SetLineWidth(2);
  ...
  eff_Stage2_iso_Option22_mean_thr21->SetLineColor(kGreen+1);
  eff_Stage2_iso_Option22_mean_thr23->SetLineColor(kRed+1);
  eff_Stage2_iso_Option22_mean_thr25->SetLineColor(kBlue+1);
 ...
 // mgbest->Add(eff_Stage2_iso_noIso_mean,"l");
  mgbest->Add(eff_Stage2_iso_Option22_mean_thr21,"l");
  mgbest->Add(eff_Stage2_iso_Option22_mean_thr23,"l");
  mgbest->Add(eff_Stage2_iso_Option22_mean_thr25,"l");
 ...
 // mgbest->Add(eff_Stage2_iso_Option22_unpacked,"l");
  ...
  TLegend* legbest = new TLegend(0.5,0.15,0.90,0.35);
  ...
  legbest->AddEntry(eff_Stage2_iso_Option22_mean_thr21,"iso Option 22 (E_{T}^{L1}#geq "+Threshold_NewLayer1_Option22_mean_thr21+" GeV)","L");
  legbest->AddEntry(eff_Stage2_iso_Option22_mean_thr23,"iso Option 22 (E_{T}^{L1}#geq "+Threshold_NewLayer1_Option22_mean_thr23+" GeV)","L");
  legbest->AddEntry(eff_Stage2_iso_Option22_mean_thr25,"iso Option 22 (E_{T}^{L1}#geq "+Threshold_NewLayer1_Option22_mean_thr25+" GeV)","L");
  legbest->Draw("same");

  texl->Draw("same");

  TString PlotNamesOutbest = "PlotIsolation/TurnOns_Option22_mean_different_thresholds";
