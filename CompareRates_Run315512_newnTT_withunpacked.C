{
  ...
  TFile f_mean("/data_CMS/cms/mperez/TauTrigger_data/2018isolation92X/histos_rate_Run315512_v1_1_newLayer1_newLayer2_newnTT.root","READ");
  TFile f_unpacked("/data_CMS/cms/mperez/TauTrigger_data/2018isolation92X/histos_rate_Run315512_v1_1_newLayer1_newLayer2_unpacked.root","READ");  
  ...
  TString CanvasName = "/data_CMS/cms/mperez/TauTrigger_data/2018isolation92X/Comparison_Rate_Run315512_newnTT_unpacked";
...
//  rate_NewLayer1_Iso_unpacked->SetLineStyle(9);
  ...
  texl->AddText("CMS Internal, #sqrt{s}=13 TeV, Run #315512 (2018)");
  ...
  TLegend* leg = new TLegend(0.35,0.64,0.87,0.87);
  leg->SetBorderSize(0);
