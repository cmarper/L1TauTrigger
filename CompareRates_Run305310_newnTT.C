{
  ...
  TFile f_mean("/home/llr/cms/mperez/TauTrigger/CMSSW_9_2_10/src/TauTagAndProbe/TauTagAndProbe/test/Trees_meanparam/histos_rate_Run305310_92X_mean_newnTT.root","READ");
  ...
  TString CanvasName = "./PlotIsolation/PlotRate/Comparison_Rate_Run305310_92X_mean_newnTT";
  ...
  rate_NewLayer1_Option1_mean->GetXaxis()->SetRangeUser(20.,70.);
  //rate_NewLayer1_Option1_mean->GetYaxis()->SetRangeUser(0.5,8.5);
  rate_NewLayer1_Option1_mean->GetYaxis()->SetTitle("Di-#tau rate [kHz]");
 ...
 // ratioPlot22_unpacked->Draw("same");
  ...
  ratioPlot->GetYaxis()->SetRangeUser(0.5,15.75);
