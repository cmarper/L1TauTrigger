...
void ApplyCalibrationZeroBias(TString InputFileName = "./Trees_modeparam/Ntuple_ZeroBias_Run305310_92X_mode.root")
// void ApplyCalibrationZeroBias(TString InputFileName = "Ntuple_ZeroBias_With2017Layer1_ShapeVeto_20_02_17.root")
{
  ...
  TFile f_histos("./Trees_modeparam/corrections_Trigger_2017_compressedieta_compressedE_hasEM_isMerged_92X_mode.root","READ");
  TH3F* h_LUT_isMerged0 = (TH3F*)f_histos.Get("LUT_isMerged0_GBRFullLikelihood_Trigger_Stage2_2017_compressedieta_compressediet_hasEM_isMerged_MC_SandeepCristina_MC_VBF");
  TH3F* h_LUT_isMerged1 = (TH3F*)f_histos.Get("LUT_isMerged1_GBRFullLikelihood_Trigger_Stage2_2017_compressedieta_compressediet_hasEM_isMerged_MC_SandeepCristina_MC_VBF");
  ...
  vector<float>   *l1tEGPt = 0;
  vector<float>   *l1tEGEta = 0;
  vector<float>   *l1tEGPhi = 0;
  vector<int>     *l1tEGQual = 0;
  vector<int>     *l1tEGIso = 0;
  ...
  TBranch        *b_l1tEGPt = 0;
  TBranch        *b_l1tEGEta = 0;
  TBranch        *b_l1tEGPhi = 0;
  TBranch        *b_l1tEGQual = 0;
  TBranch        *b_l1tEGIso = 0;
  ...
  inTree->SetBranchAddress("l1tEGPt", &l1tEGPt, &b_l1tEGPt);
  inTree->SetBranchAddress("l1tEGEta", &l1tEGEta, &b_l1tEGEta);
  inTree->SetBranchAddress("l1tEGPhi", &l1tEGPhi, &b_l1tEGPhi);
  inTree->SetBranchAddress("l1tEGQual", &l1tEGQual, &b_l1tEGQual);
  inTree->SetBranchAddress("l1tEGIso", &l1tEGIso, &b_l1tEGIso);

  TString OutputFileName = "./Trees_modeparam/calibratedOutput_Ntuple_ZeroBias_Run305310_92X_mode_EGTau.root";
  // TString OutputFileName = "calibratedOutput_Ntuple_ZeroBias_L1_07_02_17_With2017Layer1.root";
  // TString OutputFileName = "calibratedOutput_Ntuple_MC_VBF_RECO_L1_07_02_17_With2017Layer1.root";

  std::map<TString,TH3F*> histosIsolation;
  TFile f_Isolation("./Trees_modeparam/Iso_LUTs_Options_MC_92X_mode.root","READ");
  // TFile f_Isolation("Iso_LUTs_Options_MC_VBF_WithMarch2017Layer1_29_03_17.root");
  ...
  vector<float>   *out_l1tEGPt = 0;
  vector<float>   *out_l1tEGEta = 0;
  vector<float>   *out_l1tEGPhi = 0;
  vector<int>     *out_l1tEGQual = 0;
  vector<int>     *out_l1tEGIso = 0;
  ...
  outTree.Branch("l1tEGPt",&out_l1tEGPt);
  outTree.Branch("l1tEGEta",&out_l1tEGEta);
  outTree.Branch("l1tEGPhi",&out_l1tEGPhi);
  outTree.Branch("l1tEGQual",&out_l1tEGQual);
  outTree.Branch("l1tEGIso",&out_l1tEGIso);
  ...
  //for(UInt_t i = 0 ; i < 100000 ; ++i)
    {
      ...
      // loop on unpacked L1 EG
      for(UInt_t iL1EG = 0; iL1EG < l1tEGPt->size() ; ++iL1EG)
        {
          out_l1tEGPt->push_back(l1tEGPt->at(iL1EG));
          out_l1tEGEta->push_back(l1tEGEta->at(iL1EG));
          out_l1tEGPhi->push_back(l1tEGPhi->at(iL1EG));
          out_l1tEGQual->push_back(l1tEGQual->at(iL1EG));
          out_l1tEGIso->push_back(l1tEGIso->at(iL1EG));
        }
  ...
  TFile f_out_shapes("./Trees_modeparam/background_shapes_forTraining_finner_binning_Oct2017_mode.root","RECREATE");
