{
  ...
  rate_NewLayer1_Option1_mean->GetYaxis()->SetTitle("Rate [kHz]");
  ...
  TLegend* leg = new TLegend(0.67,0.24,0.89,0.87);
  leg->SetBorderSize(0);
  ...
  leg->AddEntry(rate_NewLayer1_noIso_mean,"EG-#tau no-iso","L");
  ...
  leg->AddEntry(rate_NewLayer1_Option1_mean,"EG-#tau iso (Option 1)","L");
  leg->AddEntry(rate_NewLayer1_Option2_mean,"EG-#tau iso (Option 2)","L");
  leg->AddEntry(rate_NewLayer1_Option3_mean,"EG-#tau iso (Option 3)","L");
  leg->AddEntry(rate_NewLayer1_Option4_mean,"EG-#tau iso (Option 4)","L");
  ...
  leg->AddEntry(rate_NewLayer1_Option8_mean,"EG-#tau iso (Option 8)","L");
  ...
  leg->AddEntry(rate_NewLayer1_Option22_mean,"EG-#tau iso (Option 22)","L");
