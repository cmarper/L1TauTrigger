...
void ApplyIsolationForTurnOns(TString InputFileName = "./Trees_meanparam/calibratedOutput_Ntuple_MC_92X_mean.root", Bool_t nTTRange = kTRUE)
{
  ...
  Double_t Threshold_NewLayer1_Option8 = 47.51;
  ...
  Double_t Threshold_NewLayer1_Option22 = 47.51;  
  ...
  TString FileNameOut = "./Trees_meanparam/turnOns_Option8_22_mean_highcut";
