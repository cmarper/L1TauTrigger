...
options.outputFile = 'NTuple_MC_RAW_92X_reEmul_v1_8_4.root'
options.inputFiles = []
...
if not isMC: # will use 80X
    ...
    #process.GlobalTag.globaltag = '92X_upgrade2017_realistic_v11'
...
# BEFORE process.load("L1Trigger.L1TCalorimeter.caloStage2Params_2017_v1_10_mean_inconsistent_cfi")
