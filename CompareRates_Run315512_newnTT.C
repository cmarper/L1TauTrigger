{
  ...
  TFile f_mean("/data_CMS/cms/mperez/TauTrigger_data/2018CalibIsolation/histos_rate_Run315512_v1_8_4_180509.root","READ");
  ...
  TString CanvasName = "/data_CMS/cms/mperez/TauTrigger_data/2018CalibIsolation/Comparison_Rate_Run315512_92X_v1_8_4_180509_newnTT";
  ...
  rate_NewLayer1_Option22_mean->SetTitle("");
  rate_NewLayer1_Option22_mean->GetXaxis()->SetRangeUser(20.,70.);
  //rate_NewLayer1_Option1_mean->GetYaxis()->SetRangeUser(0.5,8.5);
  rate_NewLayer1_Option22_mean->GetYaxis()->SetTitle("Di-#tau rate [kHz]");
  ...
  rate_NewLayer1_Option22_mean->Draw();
  ...
  texl->AddText("CMS Internal, #sqrt{s}=13 TeV, Run #315512");
  ...
  TLegend* leg = new TLegend(0.67,0.64,0.89,0.87);
  leg->SetBorderSize(0);
