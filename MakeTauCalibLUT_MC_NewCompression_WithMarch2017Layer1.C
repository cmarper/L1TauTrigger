...
{
  TFile* fLUTS ;
  if(withLayer1) fLUTS = new TFile ("/home/llr/cms/mperez/TauTrigger/CMSSW_9_2_10/src/TauTagAndProbe/TauTagAndProbe/test/Trees_meanparam/corrections_Trigger_2017_compressedieta_compressedE_hasEM_isMerged_92X_mean.root");
  else fLUTS = new TFile ("/home/llr/cms/mperez/TauTrigger/CMSSW_9_2_10/src/TauTagAndProbe/TauTagAndProbe/test/Trees_meanparam/corrections_Trigger_2017_compressedieta_compressedE_hasEM_isMerged_92X_mean.root");

  TH3F* LUT_isMerged0 ;
  TH3F* LUT_isMerged1 ;
  LUT_isMerged0 = (TH3F*) fLUTS->Get ("LUT_isMerged0_GBRFullLikelihood_Trigger_Stage2_2017_compressedieta_compressediet_hasEM_isMerged_MC_SandeepCristina_MC_VBF");
  LUT_isMerged1 = (TH3F*) fLUTS->Get ("LUT_isMerged1_GBRFullLikelihood_Trigger_Stage2_2017_compressedieta_compressediet_hasEM_isMerged_MC_SandeepCristina_MC_VBF");
  ...
  // outFile = "corrections/Tau_Calibration_LUT_MC_NewCompression_v7.0.0.txt";
