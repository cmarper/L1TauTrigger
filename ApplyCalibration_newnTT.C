...
const Int_t hardcodednTTBins[NbinsnTT] = {0,26,31,36,41,46,51,56,61,66,71,76,81,86,91,96,101,106,111,131,151,171,201,255 }; //new nTT CMP
...
void ApplyCalibration(TString InputFileName = "/data_CMS/cms/mperez/TauTrigger_data/2018isolation92X/outputForCalibration_compressed_Ntuple_MC_92X_v1_1_newLayer1.root")
{
  ...
  TString OutputFileName = "/data_CMS/cms/mperez/TauTrigger_data/2018isolation92X/calibratedOutput_Ntuple_MC_92X_newLayer1_newLayer2_newnTT.root";
