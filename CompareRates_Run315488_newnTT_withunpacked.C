{
  ...
  TFile f_mean("/data_CMS/cms/mperez/TauTrigger_data/2018CalibIsolation/histos_rate_Run315488_v1_8_4_180509.root","READ");
  TFile f_unpacked("/data_CMS/cms/mperez/TauTrigger_data/2018CalibIsolation/histos_rate_Run315488_v1_8_4_180509_unpacked.root","READ");  
  ...
  TString CanvasName = "/data_CMS/cms/mperez/TauTrigger_data/2018CalibIsolation/Comparison_Rate_Run315488_92X_v1_8_4_180509_newnTT_withunpacked";
  ...
  rate_NewLayer1_noIso_unpacked->SetLineColor(kGreen+2);
...
//  rate_NewLayer1_Iso_unpacked->SetLineStyle(9);
  ...
  texl->AddText("CMS Internal, #sqrt{s}=13 TeV, Run 315488 (PU = 35-60)");
  ...
  TLegend* leg = new TLegend(0.33,0.6,0.89,0.89);
  leg->SetBorderSize(0);
  ...
  leg->AddEntry(rate_NewLayer1_noIso_unpacked,"non-isolated, unpacked (old nTT)","L");
  leg->AddEntry(rate_NewLayer1_noIso_mean,"non-isolated, reemulated (new nTT)","L");
  leg->AddEntry(rate_NewLayer1_Iso_unpacked,"isolated (Option 22), unpacked (old nTT)","L");
  ...
  */
  leg->AddEntry(rate_NewLayer1_Option22_mean,"isolated (Option 22), reemulated (new nTT)","L");
 ...
 //
  ...
  ratioPlot->GetYaxis()->SetRangeUser(0.9,3);
  ratioPlot->GetYaxis()->SetTitle("No-iso/iso(Opt.22)");
