...
{ 
  //output files 
  FILE *fnoIso = fopen("rates_PU_306091_mean/rate_PU_noIso_run306092.txt", "w");
  FILE *fOption1 = fopen("rates_PU_306091_mean/rate_PU_Option1_run306092.txt", "w");
  FILE *fOption2 = fopen("rates_PU_306091_mean/rate_PU_Option2_run306092.txt", "w");
  FILE *fOption3 = fopen("rates_PU_306091_mean/rate_PU_Option3_run306092.txt", "w");
  FILE *fOption4 = fopen("rates_PU_306091_mean/rate_PU_Option4_run306092.txt", "w");
  FILE *fOption5 = fopen("rates_PU_306091_mean/rate_PU_Option5_run306092.txt", "w");
  FILE *fOption6 = fopen("rates_PU_306091_mean/rate_PU_Option6_run306092.txt", "w");
  FILE *fOption7 = fopen("rates_PU_306091_mean/rate_PU_Option7_run306092.txt", "w");
  FILE *fOption8 = fopen("rates_PU_306091_mean/rate_PU_Option8_run306092.txt", "w");
  FILE *fOption9 = fopen("rates_PU_306091_mean/rate_PU_Option9_run306092.txt", "w");
  FILE *fOption10 = fopen("rates_PU_306091_mean/rate_PU_Option10_run306092.txt", "w");
  FILE *fOption11 = fopen("rates_PU_306091_mean/rate_PU_Option11_run306092.txt", "w");
  FILE *fOption12 = fopen("rates_PU_306091_mean/rate_PU_Option12_run306092.txt", "w");
  FILE *fOption13 = fopen("rates_PU_306091_mean/rate_PU_Option13_run306092.txt", "w");
  FILE *fOption14 = fopen("rates_PU_306091_mean/rate_PU_Option14_run306092.txt", "w");
  FILE *fOption15 = fopen("rates_PU_306091_mean/rate_PU_Option15_run306092.txt", "w");
  FILE *fOption16 = fopen("rates_PU_306091_mean/rate_PU_Option16_run306092.txt", "w");
  FILE *fOption17 = fopen("rates_PU_306091_mean/rate_PU_Option17_run306092.txt", "w");
  FILE *fOption18 = fopen("rates_PU_306091_mean/rate_PU_Option18_run306092.txt", "w");
  FILE *fOption19 = fopen("rates_PU_306091_mean/rate_PU_Option19_run306092.txt", "w");
  FILE *fOption20 = fopen("rates_PU_306091_mean/rate_PU_Option20_run306092.txt", "w");
  FILE *fOption21 = fopen("rates_PU_306091_mean/rate_PU_Option21_run306092.txt", "w");
  FILE *fOption22 = fopen("rates_PU_306091_mean/rate_PU_Option22_run306092.txt", "w");
...
//  cout << "debug1" << endl;
 ...
 // cout << "debug2b" << endl;
  ...
  float nb = 1866.;
  //float thisLumiRun = 1.15E34;
  //float thisLumiRun = 1.50E34; //306091
  float thisLumiRun = 9.58E33;//306092
  float scaleToLumi = 2.00E34;
  float scale = 0.001*(nb*11245.6)*scaleToLumi/thisLumiRun;
