...
fData = TFile.Open("/home/sbhowmik/L1TauTrigger_NTuple/NTuple_SingleMu_Run2017BCD_forFit.root")
tData = fData.Get("TagAndProbe")

fOut = TFile("results/plotOutData_vsEtaPt_SingleMu_Run2017BCD.root", "recreate")
...
#ptBinning  = [26, 30, 40, 50, 60, 80, 120, 200, 500]
ptBinning  = [26, 30, 40, 50, 60, 70, 80, 100, 120]
