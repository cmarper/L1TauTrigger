...
void doFits()
{
    TFile* fIn = new TFile ("results/plotOutData_SingleMu_2018A_315252_315488.root");
    TFile* fOut = new TFile ("results/plotOutDataFitted_SingleMu_2018A_315252_315488.root", "recreate");
	...
	//CBFuncAsymm->SetParameters   (1.0, 0.11, 1.3, 4.3, 1., 0.3755, 1.);
	//CBFuncAsymm->SetParameters   (1.0, 0.11, 1.3, 4.3, 1., 0.364, 1.);
