{
  ...
  TFile f_mean("./Trees_meanparam/histos_rate_Run305310_92X_mean.root","READ");
  ...
  TString CanvasName = "./PlotIsolation/PlotRate/Comparison_Rate_DiTau_Iso_Run305310_withunpacked_92X_modemean";
  ...
  rate_NewLayer1_noIso_unpacked->GetXaxis()->SetRangeUser(20.,70.);
  ...
  //rate_NewLayer1_noIso->SetLineStyle(2);
  rate_NewLayer1_noIso_mean->SetLineColor(kGreen-7);
  ...
  TLegend* leg = new TLegend(0.44,0.51,0.89,0.81);
  leg->SetBorderSize(0);
  ...
  leg->AddEntry(rate_NewLayer1_Option22_mean,"Di-#tau iso (Option 22), mean","L");
  ...
  ratioPlot->GetYaxis()->SetRangeUser(0.75,4.75);
