{
  ...
  TString CanvasName = "./PlotIsolation/PlotRate/Comparison_Rate_Run305310_92X_mean_EGTau";
  ...
  rate_NewLayer1_Option22_mean->SetLineColor(kGray+2);
  ...
  TPaveText* texl = new TPaveText(0.3,0.87,0.95,0.99,"NDC");
  ...
  TLegend* leg = new TLegend(0.7,0.24,0.89,0.87);
  leg->SetBorderSize(0);
  ...
  leg->AddEntry(rate_NewLayer1_Option5_mean,"#tau iso (Option 5)","L");
  leg->AddEntry(rate_NewLayer1_Option6_mean,"#tau iso (Option 6)","L");
  leg->AddEntry(rate_NewLayer1_Option7_mean,"#tau iso (Option 7)","L");
  leg->AddEntry(rate_NewLayer1_Option8_mean,"#tau iso (Option 8)","L");
  leg->AddEntry(rate_NewLayer1_Option9_mean,"#tau iso (Option 9)","L");
  leg->AddEntry(rate_NewLayer1_Option10_mean,"#tau iso (Option 10)","L");
  leg->AddEntry(rate_NewLayer1_Option11_mean,"#tau iso (Option 11)","L");
  leg->AddEntry(rate_NewLayer1_Option12_mean,"#tau iso (Option 12)","L");
  leg->AddEntry(rate_NewLayer1_Option13_mean,"#tau iso (Option 13)","L");
  leg->AddEntry(rate_NewLayer1_Option14_mean,"#tau iso (Option 14)","L");
  leg->AddEntry(rate_NewLayer1_Option15_mean,"#tau iso (Option 15)","L");
  leg->AddEntry(rate_NewLayer1_Option16_mean,"#tau iso (Option 16)","L");
  leg->AddEntry(rate_NewLayer1_Option17_mean,"#tau iso (Option 17)","L");
  leg->AddEntry(rate_NewLayer1_Option18_mean,"#tau iso (Option 18)","L");
  leg->AddEntry(rate_NewLayer1_Option19_mean,"#tau iso (Option 19)","L");
  leg->AddEntry(rate_NewLayer1_Option20_mean,"#tau iso (Option 20)","L");
  leg->AddEntry(rate_NewLayer1_Option21_mean,"#tau iso (Option 21)","L");
 ...
 //
  ...
  ratioPlot22_mean->SetLineColor(kGray+2);
