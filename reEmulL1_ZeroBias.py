...
if not isMC: # will use 80X
    ...
    process.source = cms.Source("PoolSource",
        fileNames = cms.untracked.vstring(
            ...
            '/store/data/Run2017F/ZeroBias/RAW/v1/000/305/310/00000/1A2112AC-12B5-E711-A7C9-02163E0143A0.root'
            #'file:/data_CMS/cms/davignon/TauTagAndProbe_WithOctober2017Calibrations/CMSSW_9_2_8/src/TauTagAndProbe/TauTagAndProbe/test/1A2112AC-12B5-E711-A7C9-02163E0143A0.root',
    ...
    from Configuration.AlCa.autoCond import autoCond
    process.GlobalTag.globaltag = '92X_upgrade2017_realistic_v11'#for VBF Hinv
