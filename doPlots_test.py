...
styl = SetLucaStyle()
fData = TFile.Open("/home/llr/cms/mperez/TauTrigger/CMSSW_9_2_10/src/TauTagAndProbe/TauTagAndProbe/test/2018MC/NTuple_MC_VBFHToTauTau_MiniAOD_180815.root")
tData = fData.Get("Ntuplizer_noTagAndProbe/outTreeForCalibration")
