...
void MakeTreeForCalibration(TString InputFileName = "/home/llr/cms/mperez/TauTrigger/CMSSW_9_2_10/src/TauTagAndProbe/TauTagAndProbe/test/Trees_TauSeeds/Ntuple_Merged_MC_92X_mean_seed2GeV_highstats.root")
...
// void MakeTreeForCalibration(TString InputFileName = "Ntuple_MC_VBF_RECO_L1_31_01_17_0.root")
{
  ...
  data.SetBranchAddress("l1tEmuTowerIEt", &l1tEmuTowerIEt, &b_l1tEmuTowerIEt);
  ...
  TString OutputFileName = "../Trees_TauSeeds/outputForCalibration_Ntuple_MC_92X_mean_seed2GeV_highstats.root";
  ...
  outTree.Branch("L1Tau_IEt", &out_l1tEmuTowerIEt, "L1Tau_IEt/I");
  ...
  for(UInt_t i = 0 ; i < data.GetEntries() ; ++i)
    {
	  ...
	  if(l1tEmuTowerIEt->at(iL1Tau)<4) continue; //HW units : 4 GeV here == 2GeV
      ...
      if(out_isMatched)
	{
	  ...
	  out_l1tEmuTowerIEt = l1tEmuTowerIEt->at(iMatchedL1Tau);
