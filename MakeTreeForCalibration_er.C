...
void MakeTreeForCalibration(TString InputFileName = "/home/llr/cms/mperez/TauTrigger/CMSSW_9_2_10/src/TauTagAndProbe/TauTagAndProbe/test/Trees_meanparam/Ntuple_MC_Merged_92X_mean.root")
...
// void MakeTreeForCalibration(TString InputFileName = "Ntuple_MC_VBF_RECO_L1_31_01_17_0.root")
{
  ...
  TString OutputFileName = "../Trees_etarestriction/outputForCalibration_Ntuple_MC_92X_mean_er2p2.root";
      ...
      for(UInt_t iL1Tau = 0 ; iL1Tau < l1tEmuPt->size() ; ++iL1Tau)
      	{
      	  ...
      	  // if(l1tEmuRawEt->at(iL1Tau)/2.<10.) continue;
      	  if(fabs(l1tEmuEta->at(iL1Tau))>2.2) continue;
