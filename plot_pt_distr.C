...
void plothisto ( ){
  ...
  histograms.push_back(single_plot(infiles,"Ntuplizer_noTagAndProbe_multipleTaus/TagAndProbe","l1tPt[0]","l1tPt[0]<100", 50,0,100));
  histograms.push_back(single_plot(infiles,"Ntuplizer_noTagAndProbe_multipleTaus/TagAndProbe","l1tPt[1]","l1tPt[1]<100", 50,0,100));
