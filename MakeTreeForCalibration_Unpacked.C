...
//void MakeTreeForCalibration(TString InputFileName = "/home/llr/cms/mperez/TauTrigger/CMSSW_9_2_10/src/TauTagAndProbe/TauTagAndProbe/test/Trees/Ntuple_MC_MiniAOD_92X_261017.root")
void MakeTreeForCalibration(TString InputFileName = "/home/llr/cms/mperez/TauTrigger/CMSSW_9_2_10/src/TauTagAndProbe/TauTagAndProbe/test/Trees/Ntuple_MC_Merged_92X_v1_10_mode_261017_0.root")
...
{
  //TChain data("Ntuplizer_noTagAndProbe/TagAndProbe");
  ...
  //cout << "debug size " << l1tPt->size() << endl;
  ...
  TString OutputFileName = "Trees_modeparam/outputForCalibration_Ntuple_MC_92X_mode_Unpacked.root";
  ...
  outTree.Branch("L1Tau_pt",  &out_l1tPt,  "L1Tau_pt/F");
  //outTree.Branch("L1Tau_eta", &out_l1tEmuEta, "L1Tau_eta/F");
  outTree.Branch("L1Tau_eta", &out_l1tEta, "L1Tau_eta/F");
  //outTree.Branch("L1Tau_phi", &out_l1tEmuPhi, "L1Tau_phi/F");
  outTree.Branch("L1Tau_phi", &out_l1tPhi, "L1Tau_phi/F");
  ...
  outTree.Branch("L1Tau_Iso", &out_l1tIso, "L1Tau_Iso/I");
  ...
  for(UInt_t i = 0 ; i < data.GetEntries() ; ++i)
    {
      ...
      for(UInt_t iL1Tau = 0 ; iL1Tau < l1tPt->size() ; ++iL1Tau)   //l1tEmuPt->size()
      	{
      	  if(l1tPt->at(iL1Tau)<10.) continue; //l1tEmuRawET/2
      	  if(fabs(l1tEta->at(iL1Tau))>2.1) continue;

      	  TLorentzVector L1Tau; //unpacked
