...
{ 
  //output files 
  FILE *fnoIso = fopen("rates_PU_306091_mean/rate_PU_noIso_run306091_newnTT.txt", "w");
  FILE *fOption1 = fopen("rates_PU_306091_mean/rate_PU_Option1_run306091_newnTT.txt", "w");
  FILE *fOption2 = fopen("rates_PU_306091_mean/rate_PU_Option2_run306091_newnTT.txt", "w");
  FILE *fOption3 = fopen("rates_PU_306091_mean/rate_PU_Option3_run306091_newnTT.txt", "w");
  FILE *fOption4 = fopen("rates_PU_306091_mean/rate_PU_Option4_run306091_newnTT.txt", "w");
  FILE *fOption5 = fopen("rates_PU_306091_mean/rate_PU_Option5_run306091_newnTT.txt", "w");
  FILE *fOption6 = fopen("rates_PU_306091_mean/rate_PU_Option6_run306091_newnTT.txt", "w");
  FILE *fOption7 = fopen("rates_PU_306091_mean/rate_PU_Option7_run306091_newnTT.txt", "w");
  FILE *fOption8 = fopen("rates_PU_306091_mean/rate_PU_Option8_run306091_newnTT.txt", "w");
  FILE *fOption9 = fopen("rates_PU_306091_mean/rate_PU_Option9_run306091_newnTT.txt", "w");
  FILE *fOption10 = fopen("rates_PU_306091_mean/rate_PU_Option10_run306091_newnTT.txt", "w");
  FILE *fOption11 = fopen("rates_PU_306091_mean/rate_PU_Option11_run306091_newnTT.txt", "w");
  FILE *fOption12 = fopen("rates_PU_306091_mean/rate_PU_Option12_run306091_newnTT.txt", "w");
  FILE *fOption13 = fopen("rates_PU_306091_mean/rate_PU_Option13_run306091_newnTT.txt", "w");
  FILE *fOption14 = fopen("rates_PU_306091_mean/rate_PU_Option14_run306091_newnTT.txt", "w");
  FILE *fOption15 = fopen("rates_PU_306091_mean/rate_PU_Option15_run306091_newnTT.txt", "w");
  FILE *fOption16 = fopen("rates_PU_306091_mean/rate_PU_Option16_run306091_newnTT.txt", "w");
  FILE *fOption17 = fopen("rates_PU_306091_mean/rate_PU_Option17_run306091_newnTT.txt", "w");
  FILE *fOption18 = fopen("rates_PU_306091_mean/rate_PU_Option18_run306091_newnTT.txt", "w");
  FILE *fOption19 = fopen("rates_PU_306091_mean/rate_PU_Option19_run306091_newnTT.txt", "w");
  FILE *fOption20 = fopen("rates_PU_306091_mean/rate_PU_Option20_run306091_newnTT.txt", "w");
  FILE *fOption21 = fopen("rates_PU_306091_mean/rate_PU_Option21_run306091_newnTT.txt", "w");
  FILE *fOption22 = fopen("rates_PU_306091_mean/rate_PU_Option22_run306091_newnTT.txt", "w");
  ...
  // *** NTUPLES ***
  TString FileName_in = "/home/llr/cms/mperez/TauTrigger/CMSSW_9_2_10/src/TauTagAndProbe/TauTagAndProbe/test/Trees_meanparam/calibratedOutput_Ntuple_ZeroBias_Run306091_92X_mean_newnTT.root";
  ...
  for(UInt_t i = 0 ; i < inTree->GetEntries() ; ++i)
    { 
      ...
      if(PU_per_LS[in_lumi] != iPU) continue;
